#
# pytest-dependency documentation build configuration file.
#
...
htmlhelp_basename = 'pytest-dependency-doc'
...
latex_documents = [
  ('index', 'pytest-dependency.tex', u'pytest-dependency Documentation',
   u'Rolf Krahl', 'manual'),
]
...
man_pages = [
    ('index', 'pytest-dependency', u'pytest-dependency Documentation',
     [u'Rolf Krahl'], 1)
]
...
texinfo_documents = [
  ('index', 'pytest-dependency', u'pytest-dependency Documentation',
   u'Rolf Krahl', 'pytest-dependency', 
